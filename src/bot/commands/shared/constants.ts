...
export const SUMMARY_REPOS_SELECT_BLOCK_ID = "summary_repos_select_block";
export const SUMMARY_REPOS_SELECT_ACTION_ID = "summary_repos_select_action";
export const SUMMARY_ALL_REPOS_OPTION_VALUE = "__all_repos__";
