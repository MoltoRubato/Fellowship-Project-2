        ...
        elements: [
          {
            ...
            text: "For *X/Y* options, enter the real value below.",
          },
        ],
      },
      {
        ...
        label: { type: "plain_text" as const, text: "Details" },
        optional: true,
        element: {
    ...
    if (optionNeedsActualValue(selectedValue)) {
      if (!customValue) {
        return {
          ok: false,
          blockId: QUESTION_OTHER_BLOCK_ID,
          error: "Add the real value below.",
        };
      }
